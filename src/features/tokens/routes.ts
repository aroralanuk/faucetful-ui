...
import { getHypNativeContract } from '../contracts/hypErc20';
    ...
    async () => {
      ...
      for (const token of getAllTokens()) {
        ...
        if (token.type === 'native') {
          ...
          console.log('useTokenRoutes: hypTokens', hypTokens);
