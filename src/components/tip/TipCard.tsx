  ...
  return (
    <div className="relative px-3 py-3 w-100 sm:w-[31rem] bg-blue-500 shadow-lg rounded opacity-95">
      ...
      <div className="flex items-end justify-between">
        <div className="flex-grow flex items-end text-white mt-3.5  sm:text-sm">
          <p className="px-2 text-m">Current Price: </p>
          <div className="flex pr-3 items-end">
            <h1 className="flex-grow text-lg px-2" style={{ fontSize: '1.5rem' }}>
        ...
        >
          ...
          <span className="ml-1.5">Go to Uniswap</span>
        </a>
      </div>
